...
import json
# Groq API key
GROQ_API_KEY = "your_api key"  # Replace with your Groq API key
...
def analyze_text(question, answer):
    ...
    try:
        ...
        prompt = f"""You are evaluating a response in a real interview. Please analyze the response for the following criteria:
